                                        ...
                                        <div class="d-flex mb-4">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex mt-3 ms-4"> {{-- Thụt lề --}}
                                                    <div class="flex-shrink-0 me-3">
                                                        @if ($seller->img)
                                                            <img src="{{ asset('storage/' . $seller->img) }}" alt="{{ $seller->name }}"
                                                                 class="rounded-circle" style="width: 40px; height: 40px; object-fit: cover;">
                                                        @else
                                                            <img src="{{ asset('storage/profile_images/default.jpg') }}" alt="{{ $seller->name }}"
                                                                 class="rounded-circle" style="width: 40px; height: 40px; object-fit: cover;">
                                                        @endif
                                                    </div>
        ...
        @forelse ($relatedProducts as $related)
            <div class="d-flex align-items-center mb-3">
                ...
                <img src="{{ $related->images->isNotEmpty() ?
                     ...
                     alt="{{ $related->name }}" {{-- SỬA LỖI: Dùng tên của $related --}}
                     class="img-fluid rounded me-3" {{-- Thêm lại me-3 (margin) để ảnh không dính vào chữ --}}
