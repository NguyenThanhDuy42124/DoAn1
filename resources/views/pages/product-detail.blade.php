                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p class="mb-3">Tình trạng:
                                ...
                                <br>
                                <small class="text-muted">{{ $product->stock }} sản phẩm có sẵn</small>
                            </p>
                            ...
                            @else
                            @if($product->stock > 0)
                            <form action="{{ route('buyer.carts.store') }}" method="POST" class="gap-2">
                                @csrf
                                <input type="hidden" name="product_id" value="{{ $product->id }}">

                                <div class="w-25 h-25">
                                    <input type="number" name="quantity" class="form-control form-control-sm" value="1" min="1" max="{{ $product->stock }}" required>
                                </div>
                                <button type="submit" formaction="{{ route('buyer.carts.add') }}" class="btn btn-primary btn-sm mt-2 me-2 w-100 h-50">
                                    <i class="fas fa-plus me-1"></i> Thêm vào giỏ
                                </button>

                                <button type="submit" class="btn btn-success btn-sm mt-2 w-100 h-50">
