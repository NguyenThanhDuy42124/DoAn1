        ...
        <div class="shop-info bg-white p-4 rounded shadow-sm">
            <div class="d-flex flex-column flex-md-row align-items-center">
                <img src="{{ !empty($shop->img) 
                     ...
                     alt="Logo {{ $shop->name }}"
                     class="rounded-circle shop-avatar-wrapper" 
                ...
                <div class="ms-md-auto mt-4 mt-md-0 d-flex text-center">
                    ...
                    <div class="px-3 px-lg-4">
                        <div class="fs-4 fw-bold">{{ $shop->rating ?? '...' }} <i class="fas fa-star text-warning"></i></div>
                        <div class="text-muted small">Đánh giá</div>
                    </div>
                    <div class="px-3 px-lg-4">
                        <div class="fs-4 fw-bold">1.2k</div> <div class="text-muted small">Theo dõi</div>
                    </div>
                    <div class="px-3 px-lg-4">
                        <div class="fs-4 fw-bold">95%</div> <div class="text-muted small">Phản hồi Chat</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    @endforeach
        ...
        <div class="col-lg-9">
            ...
            <section class="shop-products">
                <div class="row g-4"> @forelse ($products as $product)
                        <div class="col-6 col-md-4">
                          <div class="card product-card h-100 shadow-sm">
                              {{-- <span class="badge-discount">- X%</span> --}} <img src="{{ $product->images->isNotEmpty() ?
