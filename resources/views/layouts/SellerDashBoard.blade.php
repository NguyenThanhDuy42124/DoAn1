        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg px-3">
                ...
                <div class="ml-auto d-flex align-items-center">
                                ...
                                <div class="dropdown-item {{ $notification->is_read ? '' : 'bg-light' }}">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="flex-grow-1">
                                            ...
                                            {{-- ================================================== --}}
                                            <a href="{{ route('notifications.index') }}" class="text-decoration-none text-dark {{ $notification->is_read ? '' : 'font-weight-bold' }}">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-light dropdown-toggle d-flex align-items-center" type="button" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            @if (Auth::user()->img == '')
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->shop_name) }}&background=ff6600&color=fff" width="30" height="30" class="rounded-circle mr-2">
                            @else
                            <img src="{{ asset('storage/' . Auth::user()->img) }}" width="30" height="30" class="rounded-circle mr-2">
                            @endif
                            {{ Auth::user()->shop_name }}
                        </button>
