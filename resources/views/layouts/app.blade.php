...
<body class="d-flex flex-column min-vh-100">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mb-3">
                        ...
                        <li class="mb-2">
                            ...
                            <a href="mailto:truongduy112098@gmail.com"
                                class="text-muted text-decoration-none">hotro@ddkm.com</a>
                        </li>
                        <li class="mb-2">
                            {{-- Cập nhật --}}
                            <a href="{{ route('pages.faq') }}" class="text-muted text-decoration-none">Câu hỏi thường
                                gặp</a>
                        </li>
                        <li class="mb-2">
                            {{-- Cập nhật --}}
                            <a href="{{ route('pages.warranty') }}" class="text-muted text-decoration-none">Chính sách
                                bảo hành</a>
                        </li>
                        <li class="mb-2">
                            {{-- Cập nhật --}}
                            <a href="{{ route('pages.return') }}" class="text-muted text-decoration-none">Chính sách đổi
                                trả</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2">
                            <a href="/dashboard" class="text-muted text-decoration-none">Đăng ký bán hàng</a>
                        </li>
                        <li class="mb-2">
                            {{-- Đã cập nhật --}}
                            <a href="{{ route('pages.seller-support') }}" class="text-muted text-decoration-none">Hỗ trợ
                                Người Bán</a>
                        </li>
                        <li class="mb-2">
                            {{-- Đã cập nhật --}}
                            <a href="{{ route('pages.marketplace-rules') }}" class="text-muted text-decoration-none">Quy
                                chế hoạt động Sàn</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2">
                            {{-- Cập nhật --}}
                            <a href="{{ route('pages.about') }}" class="text-muted text-decoration-none">Giới thiệu DDK
                                Mobile Market</a>
                        </li>
                        <li class="mb-2">
                            {{-- Cập nhật --}}
                            <a href="{{ route('pages.careers') }}" class="text-muted text-decoration-none">Tuyển
                                dụng</a>
                        </li>
                        <li class="mb-2">
                            {{-- Cập nhật --}}
                            <a href="{{ route('pages.privacy') }}" class="text-muted text-decoration-none">Chính sách
                                bảo mật</a>
                        </li>
                        <li class="mb-2">
                            {{-- Cập nhật --}}
                            <a href="{{ route('pages.terms') }}" class="text-muted text-decoration-none">Điều khoản sử
                                dụng</a>
                        </li>
                    </ul>
                </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js" data-livewire-eval="false">
    </script>
    @livewireScripts
    @if (config('chatify.pusher.key') != null)
        <button type="button" id="chat-bubble" class="btn btn-primary shadow rounded-circle"
